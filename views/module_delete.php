    ...
    try {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (! isset($_GET['id'])) {
                ...
                $modulesController->delete($modulesId, $login);
...
<div class='row col-md-10 justify-content-between my-5'>
    <span class='col-md-6'>
        <h1 class='h1 text-danger'>Eliminar Rol</h1>
...
<form method="POST" action="modules_delete.php?id=<?php echo $modulesId; ?>" class='row col-lg-10 col-md-10 justify-content-center was-validated'>
    <div class="row mb-3 col-lg-12 col-md-12">
        <label for="name" class="form-label">Nombre del Rol</label>
        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($modules['name']); ?>" readonly>
    </div>    
    <div class="row col-lg-6 col-md-6">
        <label for="boton" class="form-label">&nbsp;</label>
        <button id='boton' name='boton' type="submit" class="btn btn-danger col-3">Eliminar Rol</button>
    </div>
</form>
