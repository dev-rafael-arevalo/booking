...
if (isset($_COOKIE['auth_token'])) {
    ...
    try {
        ...
        if (isset($_GET['id'])) {
            $rolesId = $_GET['id'];
            $roles = $rolesController->getId($rolesId); // Obtener servicio a editar
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (! isset($_GET['id'])) {
                ...
                $rolesController->delete($rolesId, $login);
...
<form method="POST" action="roles_delete.php?id=<?php echo $rolesId; ?>" class='row col-lg-10 col-md-10 justify-content-center was-validated'>
    <div class="row mb-3 col-lg-12 col-md-12">
        <label for="name" class="form-label">Nombre del Rol</label>
        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($roles['name']); ?>" readonly>
    </div>    
