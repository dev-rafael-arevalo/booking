    ...
    try {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($name) || empty($fa_icon) || empty($type)) {
                ...
                $serviceController->update($serviceId, $name, $fa_icon, $type, $active, $login);
...
<form method="POST" action="service_edit.php?id=<?php echo $serviceId; ?>" class='row col-lg-10 col-md-10 justify-content-center was-validated'>
    ...
    <div class="row col-lg-6 col-md-6">
        ...
        <button id='boton' name='boton' type="submit" class="btn btn-primary col-3">Actualizar Servicio</button>
    </div>
</form>
</div>
