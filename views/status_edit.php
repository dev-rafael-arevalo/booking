    ...
    try {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($name)) {
                ...
                $statusController->update($statusId, $name, $active, $login);
            }
        }
...
<form method="POST" action="status_edit.php?id=<?php echo $statusId; ?>" class='row col-lg-10 col-md-10 justify-content-center was-validated'>
    <div class="row mb-3 col-lg-12 col-md-12">
        <label for="name" class="form-label required">Nombre del Estado</label>
    ...
    <div class="row col-lg-6 col-md-6">
        ...
        <button id='boton' name='boton' type="submit" class="btn btn-primary col-3">Actualizar Estado</button>
    </div>
</form>
</div>
<?php
